...
int N_init3 = 3*N/SPLIT_SIZE;
int N_init4 = 4*N/SPLIT_SIZE;
int N_init5 = 5*N/SPLIT_SIZE;

#pragma acc enter data create(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N_init4, N_init5, N, K, VAL_SIZE) create(X_result[0:N])
...
#pragma acc update device(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N_init4, N_init5, N, K, VAL_SIZE)
clock_gettime(CLOCK_REALTIME, &fpga_copyin_end);
printf("Host to FPGA time: %lf sec\n", time_diff(&fpga_copyin_start, &fpga_copyin_end));


#pragma acc data present(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N_init4, N_init5, N, K, VAL_SIZE, X_result[0:N]) pipe(pipe_temp_pap_from0to1, pipe_temp_pap_from0to2, pipe_temp_pap_from0to3, pipe_temp_pap_from0to4, pipe_temp_pap_from0to5, pipe_temp_rr2_from0to1, pipe_temp_rr2_from0to2, pipe_temp_rr2_from0to3, pipe_temp_rr2_from0to4, pipe_temp_rr2_from0to5, pipe_p_from0to1, pipe_p_from0to2, pipe_p_from0to3, pipe_p_from0to4, pipe_p_from0to5, pipe_temp_pap_from1to0, pipe_temp_pap_from1to2, pipe_temp_pap_from1to3, pipe_temp_pap_from1to4, pipe_temp_pap_from1to5, pipe_temp_rr2_from1to0, pipe_temp_rr2_from1to2, pipe_temp_rr2_from1to3, pipe_temp_rr2_from1to4, pipe_temp_rr2_from1to5, pipe_p_from1to0, pipe_p_from1to2, pipe_p_from1to3, pipe_p_from1to4, pipe_p_from1to5, pipe_temp_pap_from2to0, pipe_temp_pap_from2to1, pipe_temp_pap_from2to3, pipe_temp_pap_from2to4, pipe_temp_pap_from2to5, pipe_temp_rr2_from2to0, pipe_temp_rr2_from2to1, pipe_temp_rr2_from2to3, pipe_temp_rr2_from2to4, pipe_temp_rr2_from2to5, pipe_p_from2to0, pipe_p_from2to1, pipe_p_from2to3, pipe_p_from2to4, pipe_p_from2to5, pipe_temp_pap_from3to0, pipe_temp_pap_from3to1, pipe_temp_pap_from3to2, pipe_temp_pap_from3to4, pipe_temp_pap_from3to5, pipe_temp_rr2_from3to0, pipe_temp_rr2_from3to1, pipe_temp_rr2_from3to2, pipe_temp_rr2_from3to4, pipe_temp_rr2_from3to5, pipe_p_from3to0, pipe_p_from3to1, pipe_p_from3to2, pipe_p_from3to4, pipe_p_from3to5, pipe_temp_pap_from4to0, pipe_temp_pap_from4to1, pipe_temp_pap_from4to2, pipe_temp_pap_from4to3, pipe_temp_pap_from4to5, pipe_temp_rr2_from4to0, pipe_temp_rr2_from4to1, pipe_temp_rr2_from4to2, pipe_temp_rr2_from4to3, pipe_temp_rr2_from4to5, pipe_p_from4to0, pipe_p_from4to1, pipe_p_from4to2, pipe_p_from4to3, pipe_p_from4to5, pipe_temp_pap_from5to0, pipe_temp_pap_from5to1, pipe_temp_pap_from5to2, pipe_temp_pap_from5to3, pipe_temp_pap_from5to4, pipe_temp_rr2_from5to0, pipe_temp_rr2_from5to1, pipe_temp_rr2_from5to2, pipe_temp_rr2_from5to3, pipe_temp_rr2_from5to4, pipe_p_from5to0, pipe_p_from5to1, pipe_p_from5to2, pipe_p_from5to3, pipe_p_from5to4)
{
...
#pragma acc serial async(0) pipein(pipe_temp_pap_from1to0, pipe_temp_rr2_from1to0, pipe_p_from1to0, pipe_temp_pap_from2to0, pipe_temp_rr2_from2to0, pipe_p_from2to0, pipe_temp_pap_from3to0, pipe_temp_rr2_from3to0, pipe_p_from3to0, pipe_temp_pap_from4to0, pipe_temp_rr2_from4to0, pipe_p_from4to0, pipe_temp_pap_from5to0, pipe_temp_rr2_from5to0, pipe_p_from5to0) pipeout(pipe_temp_pap_from0to1, pipe_temp_pap_from0to2, pipe_temp_pap_from0to3, pipe_temp_pap_from0to4, pipe_temp_pap_from0to5, pipe_temp_rr2_from0to1, pipe_temp_rr2_from0to2, pipe_temp_rr2_from0to3, pipe_temp_rr2_from0to4, pipe_temp_rr2_from0to5, pipe_p_from0to1, pipe_p_from0to2, pipe_p_from0to3, pipe_p_from0to4, pipe_p_from0to5)
{
...
#pragma acc loop reduction(+:temp_rr2)
		for(int j = 0; j < N_init1; ++j){
			x[j+N_init1] += alfa * p[j+N_init1];
			r[j+N_init1] -= alfa * y[j+N_init1];
			temp_rr2 += r[j+N_init1] * r[j+N_init1];
		}
// チャネル必要(temp_rr2送信)
...
// #pragma acc loop independent
		for(int j = 0; j < N_init1; ++j){
			p[j+N_init1] = r[j+N_init1] + beta * p[j+N_init1];
		}
...
// #pragma acc loop independent
	for(int j = 0; j < N_init1; ++j){
		X_result[j+N_init1] = x[j+N_init1];
	}
}
...
#pragma acc loop reduction(+:temp_rr2)
		for(int j = 0; j < N_init1; ++j){
			x[j+N_init2] += alfa * p[j+N_init2];
			r[j+N_init2] -= alfa * y[j+N_init2];
			temp_rr2 += r[j+N_init2] * r[j+N_init2];
		}
// チャネル必要(temp_rr2送信)
...
// #pragma acc loop independent
		for(int j = 0; j < N_init1; ++j){
			p[j+N_init2] = r[j+N_init2] + beta * p[j+N_init2];
		}
...
// #pragma acc loop independent
	for(int j = 0; j < N_init1; ++j){
		X_result[j+N_init2] = x[j+N_init2];
	}
}
...
#pragma acc serial async(3) pipein(pipe_temp_pap_from0to3, pipe_temp_rr2_from0to3, pipe_p_from0to3, pipe_temp_pap_from1to3, pipe_temp_rr2_from1to3, pipe_p_from1to3, pipe_temp_pap_from2to3, pipe_temp_rr2_from2to3, pipe_p_from2to3, pipe_temp_pap_from4to3, pipe_temp_rr2_from4to3, pipe_p_from4to3, pipe_temp_pap_from5to3, pipe_temp_rr2_from5to3, pipe_p_from5to3) pipeout(pipe_temp_pap_from3to0, pipe_temp_pap_from3to1, pipe_temp_pap_from3to2, pipe_temp_pap_from3to4, pipe_temp_pap_from3to5, pipe_temp_rr2_from3to0, pipe_temp_rr2_from3to1, pipe_temp_rr2_from3to2, pipe_temp_rr2_from3to4, pipe_temp_rr2_from3to5, pipe_p_from3to0, pipe_p_from3to1, pipe_p_from3to2, pipe_p_from3to4, pipe_p_from3to5)
{
	float alfa, beta;
	float x[BLOCK_SIZE], r[BLOCK_SIZE], p[BLOCK_SIZE], y[BLOCK_SIZE];  // エミュレーションのときはコメントアウト
	float VAL_local[V_SIZE];    // エミュレーションのときはコメントアウト
...
#pragma acc loop reduction(+:temp_rr2)
		for(int j = 0; j < N_init1; ++j){
			x[j+N_init3] += alfa * p[j+N_init3];
			r[j+N_init3] -= alfa * y[j+N_init3];
			temp_rr2 += r[j+N_init3] * r[j+N_init3];
		}
// チャネル必要(temp_rr2送信)
...
// #pragma acc loop independent
		for(int j = 0; j < N_init1; ++j){
			p[j+N_init3] = r[j+N_init3] + beta * p[j+N_init3];
		}
...
// #pragma acc loop independent
	for(int j = 0; j < N_init1; ++j){
		X_result[j+N_init3] = x[j+N_init3];
	}
}
...
#pragma acc serial async(4) pipein(pipe_temp_pap_from0to4, pipe_temp_rr2_from0to4, pipe_p_from0to4, pipe_temp_pap_from1to4, pipe_temp_rr2_from1to4, pipe_p_from1to4, pipe_temp_pap_from2to4, pipe_temp_rr2_from2to4, pipe_p_from2to4, pipe_temp_pap_from3to4, pipe_temp_rr2_from3to4, pipe_p_from3to4, pipe_temp_pap_from5to4, pipe_temp_rr2_from5to4, pipe_p_from5to4) pipeout(pipe_temp_pap_from4to0, pipe_temp_pap_from4to1, pipe_temp_pap_from4to2, pipe_temp_pap_from4to3, pipe_temp_pap_from4to5, pipe_temp_rr2_from4to0, pipe_temp_rr2_from4to1, pipe_temp_rr2_from4to2, pipe_temp_rr2_from4to3, pipe_temp_rr2_from4to5, pipe_p_from4to0, pipe_p_from4to1, pipe_p_from4to2, pipe_p_from4to3, pipe_p_from4to5)
{
	float alfa, beta;
	float x[BLOCK_SIZE], r[BLOCK_SIZE], p[BLOCK_SIZE], y[BLOCK_SIZE];  // エミュレーションのときはコメントアウト
	float VAL_local[V_SIZE];    // エミュレーションのときはコメントアウト
...
#pragma acc loop reduction(+:temp_rr2)
		for(int j = 0; j < N_init1; ++j){
			x[j+N_init4] += alfa * p[j+N_init4];
			r[j+N_init4] -= alfa * y[j+N_init4];
			temp_rr2 += r[j+N_init4] * r[j+N_init4];
		}
// チャネル必要(temp_rr2送信)
...
// #pragma acc loop independent
		for(int j = 0; j < N_init1; ++j){
			p[j+N_init4] = r[j+N_init4] + beta * p[j+N_init4];
		}
...
// #pragma acc loop independent
	for(int j = 0; j < N_init1; ++j){
		X_result[j+N_init4] = x[j+N_init4];
	}
}
...
#pragma acc serial async(5) pipein(pipe_temp_pap_from0to5, pipe_temp_rr2_from0to5, pipe_p_from0to5, pipe_temp_pap_from1to5, pipe_temp_rr2_from1to5, pipe_p_from1to5, pipe_temp_pap_from2to5, pipe_temp_rr2_from2to5, pipe_p_from2to5, pipe_temp_pap_from3to5, pipe_temp_rr2_from3to5, pipe_p_from3to5, pipe_temp_pap_from4to5, pipe_temp_rr2_from4to5, pipe_p_from4to5) pipeout(pipe_temp_pap_from5to0, pipe_temp_pap_from5to1, pipe_temp_pap_from5to2, pipe_temp_pap_from5to3, pipe_temp_pap_from5to4, pipe_temp_rr2_from5to0, pipe_temp_rr2_from5to1, pipe_temp_rr2_from5to2, pipe_temp_rr2_from5to3, pipe_temp_rr2_from5to4, pipe_p_from5to0, pipe_p_from5to1, pipe_p_from5to2, pipe_p_from5to3, pipe_p_from5to4)
{
	float alfa, beta;
	float x[BLOCK_SIZE], r[BLOCK_SIZE], p[BLOCK_SIZE], y[BLOCK_SIZE];  // エミュレーションのときはコメントアウト
	float VAL_local[V_SIZE];    // エミュレーションのときはコメントアウト
...
#pragma acc loop reduction(+:temp_sum)
		for(int j = 0; j < N_init1; ++j){
			...
			y[j+N_init5] = temp_sum;
			temp_pap += p[j+N_init5] * temp_sum;
		}

// #pragma acc loop //reduction(+:temp_pap)
// 		for(int j = N_init5; j < N; ++j){
// 			temp_pap += p[j] * y[j];
// 		}
...
#pragma acc loop reduction(+:temp_rr2)
		for(int j = 0; j < N_init1; ++j){
			x[j+N_init5] += alfa * p[j+N_init5];
			r[j+N_init5] -= alfa * y[j+N_init5];
			temp_rr2 += r[j+N_init5] * r[j+N_init5];
		}
// チャネル必要(temp_rr2送信)
...
// #pragma acc loop independent
		for(int j = 0; j < N_init1; ++j){
			p[j+N_init5] = r[j+N_init5] + beta * p[j+N_init5];
		}
...
// #pragma acc loop independent
	for(int j = 0; j < N_init1; ++j){
		X_result[j+N_init5] = x[j+N_init5];
	}
}
