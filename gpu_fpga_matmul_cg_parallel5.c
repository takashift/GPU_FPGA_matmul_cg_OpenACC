...
#pragma acc enter data create(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N_init4, N, K, VAL_SIZE) create(X_result[0:N])
...
#pragma acc update device(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N_init4, N, K, VAL_SIZE)
clock_gettime(CLOCK_REALTIME, &fpga_copyin_end);
printf("Host to FPGA time: %lf sec\n", time_diff(&fpga_copyin_start, &fpga_copyin_end));


#pragma acc data present(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N_init4, N, K, VAL_SIZE, X_result[0:N]) pipe(pipe_temp_pap_from0to1, pipe_temp_pap_from0to2, pipe_temp_pap_from0to3, pipe_temp_pap_from0to4, pipe_temp_rr2_from0to1, pipe_temp_rr2_from0to2, pipe_temp_rr2_from0to3, pipe_temp_rr2_from0to4, pipe_p_from0to1, pipe_p_from0to2, pipe_p_from0to3, pipe_p_from0to4, pipe_temp_pap_from1to0, pipe_temp_pap_from1to2, pipe_temp_pap_from1to3, pipe_temp_pap_from1to4, pipe_temp_rr2_from1to0, pipe_temp_rr2_from1to2, pipe_temp_rr2_from1to3, pipe_temp_rr2_from1to4, pipe_p_from1to0, pipe_p_from1to2, pipe_p_from1to3, pipe_p_from1to4, pipe_temp_pap_from2to0, pipe_temp_pap_from2to1, pipe_temp_pap_from2to3, pipe_temp_pap_from2to4, pipe_temp_rr2_from2to0, pipe_temp_rr2_from2to1, pipe_temp_rr2_from2to3, pipe_temp_rr2_from2to4, pipe_p_from2to0, pipe_p_from2to1, pipe_p_from2to3, pipe_p_from2to4, pipe_temp_pap_from3to0, pipe_temp_pap_from3to1, pipe_temp_pap_from3to2, pipe_temp_pap_from3to4, pipe_temp_rr2_from3to0, pipe_temp_rr2_from3to1, pipe_temp_rr2_from3to2, pipe_temp_rr2_from3to4, pipe_p_from3to0, pipe_p_from3to1, pipe_p_from3to2, pipe_p_from3to4, pipe_temp_pap_from4to0, pipe_temp_pap_from4to1, pipe_temp_pap_from4to2, pipe_temp_pap_from4to3, pipe_temp_rr2_from4to0, pipe_temp_rr2_from4to1, pipe_temp_rr2_from4to2, pipe_temp_rr2_from4to3, pipe_p_from4to0, pipe_p_from4to1, pipe_p_from4to2, pipe_p_from4to3)
{
...
#pragma acc serial async(0) pipein(pipe_temp_pap_from1to0, pipe_temp_rr2_from1to0, pipe_p_from1to0, pipe_temp_pap_from2to0, pipe_temp_rr2_from2to0, pipe_p_from2to0, pipe_temp_pap_from3to0, pipe_temp_rr2_from3to0, pipe_p_from3to0, pipe_temp_pap_from4to0, pipe_temp_rr2_from4to0, pipe_p_from4to0) pipeout(pipe_temp_pap_from0to1, pipe_temp_pap_from0to2, pipe_temp_pap_from0to3, pipe_temp_pap_from0to4, pipe_temp_rr2_from0to1, pipe_temp_rr2_from0to2, pipe_temp_rr2_from0to3, pipe_temp_rr2_from0to4, pipe_p_from0to1, pipe_p_from0to2, pipe_p_from0to3, pipe_p_from0to4)
{
...
for(int j = N_init3; j < N_init4; ++j){
	p[j] = pipe_p_from3to0[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init4; j < N; ++j){
	p[j] = pipe_p_from4to0[0];
}
...
#pragma acc serial async(1) pipein(pipe_temp_pap_from0to1, pipe_temp_rr2_from0to1, pipe_p_from0to1, pipe_temp_pap_from2to1, pipe_temp_rr2_from2to1, pipe_p_from2to1, pipe_temp_pap_from3to1, pipe_temp_rr2_from3to1, pipe_p_from3to1, pipe_temp_pap_from4to1, pipe_temp_rr2_from4to1, pipe_p_from4to1) pipeout(pipe_temp_pap_from1to0, pipe_temp_pap_from1to2, pipe_temp_pap_from1to3, pipe_temp_pap_from1to4, pipe_temp_rr2_from1to0, pipe_temp_rr2_from1to2, pipe_temp_rr2_from1to3, pipe_temp_rr2_from1to4, pipe_p_from1to0, pipe_p_from1to2, pipe_p_from1to3, pipe_p_from1to4)
{
	float alfa, beta;
...
for(int j = N_init1; j < N_init2; ++j){
	...
	pipe_p_from1to3[0] = p[j];
	pipe_p_from1to4[0] = p[j];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init2; j < N_init3; ++j){
...
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init3; j < N_init4; ++j){
	p[j] = pipe_p_from3to1[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init4; j < N; ++j){
	p[j] = pipe_p_from4to1[0];
}
...
for(int j = N_init2; j < N_init3; ++j){
	...
	pipe_p_from2to3[0] = p[j];
	pipe_p_from2to4[0] = p[j];
}
for(int j = N_init3; j < N_init4; ++j){
	p[j] = pipe_p_from3to2[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init4; j < N; ++j){
	p[j] = pipe_p_from4to2[0];
}
...
for(int j = N_init1; j < N_init2; ++j){
	p[j] = pipe_p_from1to3[0];
}
for(int j = N_init2; j < N_init3; ++j){
	p[j] = pipe_p_from2to3[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init3; j < N_init4; ++j){
	pipe_p_from3to0[0] = p[j];
	pipe_p_from3to1[0] = p[j];
	pipe_p_from3to2[0] = p[j];
	pipe_p_from3to4[0] = p[j];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init4; j < N; ++j){
	p[j] = pipe_p_from4to3[0];
}
...
#pragma acc serial async(4) pipein(pipe_temp_pap_from0to4, pipe_temp_rr2_from0to4, pipe_p_from0to4, pipe_temp_pap_from1to4, pipe_temp_rr2_from1to4, pipe_p_from1to4, pipe_temp_pap_from2to4, pipe_temp_rr2_from2to4, pipe_p_from2to4, pipe_temp_pap_from3to4, pipe_temp_rr2_from3to4, pipe_p_from3to4) pipeout(pipe_temp_pap_from4to0, pipe_temp_pap_from4to1, pipe_temp_pap_from4to2, pipe_temp_pap_from4to3, pipe_temp_rr2_from4to0, pipe_temp_rr2_from4to1, pipe_temp_rr2_from4to2, pipe_temp_rr2_from4to3, pipe_p_from4to0, pipe_p_from4to1, pipe_p_from4to2, pipe_p_from4to3)
{
	float alfa, beta;
	float x[BLOCK_SIZE], r[BLOCK_SIZE], p[BLOCK_SIZE], y[BLOCK_SIZE];  // エミュレーションのときはコメントアウト
	float VAL_local[V_SIZE];    // エミュレーションのときはコメントアウト
...
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init1; j < N_init2; ++j){
	p[j] = pipe_p_from1to4[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init2; j < N_init3; ++j){
	p[j] = pipe_p_from2to4[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init3; j < N_init4; ++j){
	p[j] = pipe_p_from3to4[0];
}
// チャネル必要（各カーネルで担当外の要素の更新が必要）
for(int j = N_init4; j < N; ++j){
	pipe_p_from4to0[0] = p[j];
	pipe_p_from4to1[0] = p[j];
	pipe_p_from4to2[0] = p[j];
	pipe_p_from4to3[0] = p[j];
}
