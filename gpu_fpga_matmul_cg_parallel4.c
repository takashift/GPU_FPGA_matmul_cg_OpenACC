...
#pragma acc enter data create(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N, K, VAL_SIZE) create(X_result[0:N])
...
#pragma acc update device(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N, K, VAL_SIZE)
clock_gettime(CLOCK_REALTIME, &fpga_copyin_end);
printf("Host to FPGA time: %lf sec\n", time_diff(&fpga_copyin_start, &fpga_copyin_end));


#pragma acc data present(VAL[0:VAL_SIZE], COL_IND[0:VAL_SIZE], ROW_PTR[0:N+1], B[0:N], N_init1, N_init2, N_init3, N, K, VAL_SIZE, X_result[0:N]) pipe(pipe_temp_pap_from0to1, pipe_temp_pap_from0to2, pipe_temp_pap_from0to3, pipe_temp_rr2_from0to1, pipe_temp_rr2_from0to2, pipe_temp_rr2_from0to3, pipe_p_from0to1, pipe_p_from0to2, pipe_p_from0to3, pipe_temp_pap_from1to0, pipe_temp_pap_from1to2, pipe_temp_pap_from1to3, pipe_temp_rr2_from1to0, pipe_temp_rr2_from1to2, pipe_temp_rr2_from1to3, pipe_p_from1to0, pipe_p_from1to2, pipe_p_from1to3, pipe_temp_pap_from2to0, pipe_temp_pap_from2to1, pipe_temp_pap_from2to3, pipe_temp_rr2_from2to0, pipe_temp_rr2_from2to1, pipe_temp_rr2_from2to3, pipe_p_from2to0, pipe_p_from2to1, pipe_p_from2to3, pipe_temp_pap_from3to0, pipe_temp_pap_from3to1, pipe_temp_pap_from3to2, pipe_temp_rr2_from3to0, pipe_temp_rr2_from3to1, pipe_temp_rr2_from3to2, pipe_p_from3to0, pipe_p_from3to1, pipe_p_from3to2)
{
...
#pragma acc serial async(1) pipein(pipe_temp_pap_from0to1, pipe_temp_rr2_from0to1, pipe_p_from0to1, pipe_temp_pap_from2to1, pipe_temp_rr2_from2to1, pipe_p_from2to1, pipe_temp_pap_from3to1, pipe_temp_rr2_from3to1, pipe_p_from3to1) pipeout(pipe_temp_pap_from1to0, pipe_temp_pap_from1to2, pipe_temp_pap_from1to3, pipe_temp_rr2_from1to0, pipe_temp_rr2_from1to2, pipe_temp_rr2_from1to3, pipe_p_from1to0, pipe_p_from1to2, pipe_p_from1to3)
{
	float alfa, beta;
...
#pragma acc serial async(2) pipein(pipe_temp_pap_from0to2, pipe_temp_rr2_from0to2, pipe_p_from0to2, pipe_temp_pap_from1to2, pipe_temp_rr2_from1to2, pipe_p_from1to2, pipe_temp_pap_from3to2, pipe_temp_rr2_from3to2, pipe_p_from3to2) pipeout(pipe_temp_pap_from2to0, pipe_temp_pap_from2to1, pipe_temp_pap_from2to3, pipe_temp_rr2_from2to0, pipe_temp_rr2_from2to1, pipe_temp_rr2_from2to3, pipe_p_from2to0, pipe_p_from2to1, pipe_p_from2to3)
{
	float alfa, beta;
	float x[BLOCK_SIZE], r[BLOCK_SIZE], p[BLOCK_SIZE], y[BLOCK_SIZE];  // エミュレーションのときはコメントアウト
	float VAL_local[V_SIZE];    // エミュレーションのときはコメントアウト
